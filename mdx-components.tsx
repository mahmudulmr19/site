...
const components = {
  ...
  p: (props: ParagraphProps) => (
    <p className="text-copy text-[17px]  my-5" {...props} />
  ),
  ol: (props: ListProps) => (
  ...
  a: ({ href, children, ...props }: AnchorProps) => {
    const className =
      "transition-colors underline decoration-neutral-500 decoration-1 underline-offset-[2.5px] hover:decoration-neutral-600";
    if (href?.startsWith("/")) {
      return (
  ...
  blockquote: (props: BlockquoteProps) => (
    <blockquote
      className="ml-[0.075em] border-l-3 pl-4 border-zinc-600 text-zinc-300"
      {...props}
    />
  ),
};
